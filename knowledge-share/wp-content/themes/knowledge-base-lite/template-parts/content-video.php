      ...
      <?php if( get_theme_mod( 'knowledge_base_lite_toggle_postdate',true) == 1 || get_theme_mod( 'knowledge_base_lite_toggle_author',true) == 1 || get_theme_mod( 'knowledge_base_lite_toggle_comments',true) == 1 || get_theme_mod( 'knowledge_base_lite_toggle_time',true) == 1) { ?>
        <div class="post-info p-2 my-3">
          ...
          <?php if(get_theme_mod('knowledge_base_lite_toggle_author',true)==1){ ?>
            <span><?php echo esc_html(get_theme_mod('knowledge_base_lite_meta_field_separator', '|'));?></span> <i class="fas fa-user"></i><span class="entry-author"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_author(); ?></span></a></span>
          <?php } ?>

          <?php if(get_theme_mod('knowledge_base_lite_toggle_comments',true)==1){ ?>
            <span><?php echo esc_html(get_theme_mod('knowledge_base_lite_meta_field_separator', '|'));?></span> <i class="fa fa-comments" aria-hidden="true"></i><span class="entry-comments"><?php comments_number( __('0 Comment', 'knowledge-base-lite'), __('0 Comments', 'knowledge-base-lite'), __('% Comments', 'knowledge-base-lite') ); ?></span>
          <?php } ?>

          <?php if(get_theme_mod('knowledge_base_lite_toggle_time',true)==1){ ?>
            <span><?php echo esc_html(get_theme_mod('knowledge_base_lite_meta_field_separator', '|'));?></span> <i class="fas fa-clock"></i><span class="entry-time"><?php echo esc_html( get_the_time() ); ?></span>
          <?php } ?>
        </div>
      <?php } ?>
      <p class="mb-0">
