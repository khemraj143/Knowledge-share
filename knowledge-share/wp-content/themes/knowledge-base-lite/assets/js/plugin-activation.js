jQuery(document).ready(function($) {
    'use strict';
    var this_obj = knowledge_base_lite_plugin_activate_plugin;

    $(document).on('click', '.knowledge-base-lite-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message knowledge-base-lite-plugin-install');
                button.addClass('button-primary knowledge-base-lite-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.knowledge-base-lite-recommended-plugins .knowledge-base-lite-activation-note').css('display','block');
    ...
    $(document).on('click', '.knowledge-base-lite-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .knowledge-base-lite-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .knowledge-base-lite-recommended-plugins').css('display','none');
    });
