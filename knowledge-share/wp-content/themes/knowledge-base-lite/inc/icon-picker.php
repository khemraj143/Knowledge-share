...
class Knowledge_Base_Lite_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'knowledge-base-lite' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $knowledge_base_lite_font_awesome_icon_array = knowledge_base_lite_font_awesome_icon_array();
                    foreach ($knowledge_base_lite_font_awesome_icon_array as $knowledge_base_lite_font_awesome_icon) {
                            $icon_class = $this->value() == $knowledge_base_lite_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($knowledge_base_lite_font_awesome_icon).'"></i>
                            <span class="knowledge-base-lite-social-class">'.esc_attr($knowledge_base_lite_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function knowledge_base_lite_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'knowledge-base-lite-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'knowledge_base_lite_customizer_script' );

if(!function_exists('knowledge_base_lite_font_awesome_icon_array')){
    function knowledge_base_lite_font_awesome_icon_array(){
