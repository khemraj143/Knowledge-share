...
class Knowledge_Base_Lite_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Knowledge_Base_Lite_About_Widget',
			__('VW About us', 'knowledge-base-lite'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'knowledge-base-lite' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','knowledge-base-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','knowledge-base-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','knowledge-base-lite'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','knowledge-base-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','knowledge-base-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','knowledge-base-lite'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function knowledge_base_lite_about_custom_load_widget() {
	register_widget( 'Knowledge_Base_Lite_About_Widget' );
}
add_action( 'widgets_init', 'knowledge_base_lite_about_custom_load_widget' );